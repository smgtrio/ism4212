...
?>  <!-- close PHP to use HTML for table ### -->
        ...
        <tr>        <!-- ### TR is a row. We have one row contains the info then foreach loop ### -->
    <td>    <!-- ### print the value in HTML code using PHP code ### -->
        ...
        <td>  <img src='data:image/jpg;base64,<?php echo base64_encode( $image ); ?>' style='height:24' >  </td> 
